...
echo -e "($CURRENT_STEP/$TOTAL_STEP) dnf 업데이트 시작"
...
echo -e "($CURRENT_STEP/$TOTAL_STEP) 도커 설치 시작"
...
echo -e "($CURRENT_STEP/$TOTAL_STEP) GitLab 설치 시작"
...
echo -e "($CURRENT_STEP/$TOTAL_STEP) 서버 재부팅 시 gitlab 자동 실행 설정 시작"
...
echo -e "($CURRENT_STEP/$TOTAL_STEP) 서버 재부팅 시 gitlab 자동 실행 설정 완료\n"
$CURRENT_STEP=$CURRENT_STEP+1
